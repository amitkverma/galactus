...
def ensure(module, client):
    ...
    module_user = get_user_dict(givenname=module.params.get('givenname'), loginshell=module.params['loginshell'],
                                ...
                                telephonenumber=module.params['telephonenumber'], title=module.params['title'], gidnumber=module.params['gidnumber'])
